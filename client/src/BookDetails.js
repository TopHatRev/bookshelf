...
export default function BookDetails() {
  ...
  return (
    <div>
      ...
      <form className="input-field" onSubmit={handleUpdateBook}>
        <input name="title" value={form.title} placeholder={book.title} onChange={handleChange} />
        <input name="year" value={form.year} placeholder={book.year} onChange={handleChange} />
        <input name="author" value={form.author} placeholder={book.author} onChange={handleChange} />
        <input
          name="countryOfOrigin"
          value={form.countryOfOrigin}
          placeholder={book.countryOfOrigin}
          onChange={handleChange}
        />
        <input name="description" value={form.description} placeholder={book.description} onChange={handleChange} />
        <input name="status" value={form.status} placeholder={book.status} onChange={handleChange} />
